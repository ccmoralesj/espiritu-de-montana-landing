          ...
          <div className="hidden md:flex gap-4">
            {adventureTypes.map((type) => (
              <Button
                ...
                className={`font-body text-lg px-8 py-3 rounded-full transition-all ${selectedType === type
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button
                variant="outline"
                className="font-body text-lg px-8 py-3 rounded-full border-secondary text-secondary text-lg tracking-wider hover:border-foreground hover:text-foreground"
              >
                CONOCER MÁS
              </Button>
              <Button
