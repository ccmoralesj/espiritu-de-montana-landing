...
const LocalRouteCard: React.FC<OneRouteProps> = ({ route, selectedLocation }) => {
  return (
    <>
      {/* Image */}
      <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-center
            ${selectedLocation === route.title.toUpperCase()
          ? "block"
          : "hidden"
        }`}>
        <div className="">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-4 md:flex-row mdgap-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-body font-semibold text-secondary">{route.duration}</span>
            </div>
