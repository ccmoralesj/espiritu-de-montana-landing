...
const Routes = () => {
  ...
  const filteredRoutes = selectedCategory === 'all' 
    ? allRoutes 
    : allRoutes.filter(route => route.category === selectedCategory);
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h1 className="font-title text-4xl lg:text-6xl text-secondary uppercase leading-tight tracking-wide mb-4">
              NUESTRAS RUTAS
            </h1>
            <p className="font-body text-xl text-muted-foreground max-w-2xl mx-auto">
              Descubre aventuras únicas diseñadas para exploradores como tú
            </p>
          </div>
